...
class SavingsAccount extends BankAccount {
    ...
    public void withdraw(double amount) {
        if (getBalance() - amount < 100) {
            System.out.println("Minimum bvalance of $100 required! ");
...
class nain {
    public static void main(String args[]) {
        ...
        BA1234.deposit(1000);
        System.out.println("New balance after deposit $1000: $" + BA1234.getBalance());
        System.out.println("Witthdraw $600 from account BA1234: ");
        BA1234.withdraw(600);
        ...
        SA1234.withdraw(300);
        System.out.println("Balance after try to withdraw $300: $" + SA1234.getBalance());
